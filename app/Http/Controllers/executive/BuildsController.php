...
class BuildsController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('executive.builds.index',compact('builds'))
    ...
    public function employeeBuild($id)
    {
        ...
        if($employee == 0){
            return redirect()->route('executive.builds.list')->with('errors','Employee not found.');
        }
    ...
    public function create(Request $request)
    {
        ...
        //     Session::save();
        // }
        return view('executive.builds.create')->with('builds_data', $builds_data);
    }
    ...
    public function show($id)
    {
        if($id && $id > 0){
            ...
            if($builds){
                ...
                return redirect()->route('executive.builds.list')->with('errors','No builds Found.');
            }
            
        } else {
            return redirect()->route('executive.builds.list')->with('errors','Parameter missing.');
        }
    }
    ...
    public function edit(Builds $builds,$id)
    {
        ...
        if($builds->status != '-1'){
            return view('executive.builds.edit');
        }
        ...
        //     Session::save();
        // }
        return view('executive.builds.edit',compact('builds'))->with('builds_data', $builds_data);
    }
            ...
            if($get_build->challenge_id == $request['challenge']){
                ...
                if($check_chall == 0){
                    ...
                    if($challenge != 0){
                        ...
                        return redirect()->route('executive.builds.list',['id'=>$id])->with('error','The challenge is not available.');
                    }
                } else {
                    return redirect()->route('executive.builds.list',['id'=>$id])->with('error','The selected challenge already rejected.');
                }
            }
        }
        ...
        if($builds_data['challenge_id'] == 0)        
        {
          ...
          $title_reject = "Submission Rejected ";
            ...
            if($request['status'] == 0 ){
                   ...
                   $message = "Sorry ".$employee->full_name.". Your Submission ".$request['build_text']." is rejected.";
                   ...
                   $message = "Congratulations ".$employee->full_name.". Your Submission ".$request['build_text']." is approved.";
                    ...
                    $api->sendpush($builds_data -> employee_id,$title_app,$message,$data,'UploadApprove');
                }
    ...
    public function destroy(Builds $builds,$id)
    {
        ...
        if($builds && $builds != ''){
            ...
            return redirect()->route('executive.builds.list')->with('error','No builds Found.');
        }
        ...
        //     }
        // }
        return redirect()->route('executive.builds.list')->with('success','Builds Deleted successfully.');
    }
