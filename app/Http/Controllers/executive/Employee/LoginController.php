...
namespace App\Http\Controllers\executive\Employee;
...
{    
    ...
    */
     ...
     * @var string
     */
    protected $redirectTo = 'executive/employee/dashboard/home';
    ...
    public function showLoginForm()
    {
      ...
      if (Session::has('employee')) {
          return redirect()->intended('executive/employee/dashboard/home');
      }
