...
class TenureController extends Controller
{
    ...
    public function index()
    {
      if(Auth::guard('admin')->user()->access_level == 5 ){
        ...
        return view('executive.tenure.index',compact('tenure'))
    ...
    public function employeeTenure($id)
    {
        ...
        if($employee == 0){
            return redirect()->route('executive.tenure.list')->with('errors','Employee not found.');
        }
    ...
    {
        return view('executive.tenure.index');
    }
