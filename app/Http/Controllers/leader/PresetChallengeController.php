...
class PresetChallengeController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('leader.preset_challenge.index',compact('challenge'))
    ...
    public function create()
    {
        ...
        return view('leader.preset_challenge.create')->with('challenge_data', $challenge_data);
    }
    ...
    public function show($id)
    {
        if($id && $id > 0){
            ...
            if($challenge){
                ...
                return view('leader.preset_challenge.show',compact('challenge'));
            } else {
    ...
    public function edit($id)
    {
        ...
        //Accesslevel::all();
        return view('leader.preset_challenge.edit',compact('challenge'))->with('challenge_data', $challenge_data);
    }
