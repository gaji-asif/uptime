...
namespace App\Http\Controllers\leader\Employee;
...
{    
    ...
    */
     ...
     * @var string
     */
    protected $redirectTo = 'leader/employee/dashboard/home';
    ...
    public function showLoginForm()
    {
      ...
      if (Session::has('employee')) {
          return redirect()->intended('leader/employee/dashboard/home');
      }
