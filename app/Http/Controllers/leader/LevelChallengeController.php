...
class LevelChallengeController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('leader.level_challenge.index');
    }
   ...
   public function updatechallengebyexpirydate(){
    ...
    public function create()
    {
        ...
        $challenge_data['access_level_data'] = Accesslevel::where('id','<=',2)->get()->toArray();
        return view('leader.level_challenge.create')->with('challenge_data', $challenge_data);
    ...
    public function store(Request $request)
    {
       ...
       if(empty($request['subcategory'])){
        ...
        return redirect()->route('leader.level-challenge.list')->with('success','Challenge created successfully.');
    ...
    public function show($id)
    {
        if($id && $id > 0){
            ...
            if($challenge){
                ...
                return view('leader.level_challenge.show',compact('challenge'));
            } 
            else {
                return redirect()->route('leader.level-challenge.list')->with('errors','No challenge Found.');
            }
    ...
    public function edit($id)
    {
       ...
       return view('leader.level_challenge.edit',compact('challenge'))->with('challenge_data', $challenge_data);
    }
    ...
    public function update(Request $request, $id)
    {
       ...
       $kind = $request['sent_to'];   
        ...
        return redirect()->route('leader.level-challenge.list')->with('success','Challenge updated successfully.');
    ...
    public function delete($id)
    {
        ...
        if($challenge->is_active == 0){
             return response()->json(['status'=>false,'message'=>"Can't Delete Expiry Challenge"]);
        }
        else{
	        if($challenge == ''){
  ...
  public function getaccesslevel(){
       ...
       $data= AccessLevel::whereIn('id',array(0,2))->get();
   ...
   public function getaccesslevelbyregion(){
  
       $data= AccessLevel::where('id',Session::get('employee')->access_level)->first();
       ...
       if(!empty($data)){
           ...
           <option value="">select Accesslevel</option>';
                        ...
                        $html .= '<option value="'.$data['id'].'">'.$data['access_level_name'].'</option>';
  ...
  public function getregion($id){
        ...
        if($id && ($id == '1' || $id == '2' ))       
        {
            // if($id == 1 )  $data = Industry::select('id','industry_name')->where('id',Session::get('employee')->industry)->get()->toArray();
            if($id == 1 )  $data = Industry::select('id','industry_name')->where('company_id',Session::get('employee')->company_id)->get()->toArray();
            if($id == 2 )  $data = Industry::where('id',Session::get('employee')->industry)->first();
            if(!empty($data)){
