...
class TierController extends Controller
{
    ...
    public function create()
    {
        ...
        if($tiers_count == 9)  return redirect('leader/tier')->with('errors','Maximum amount of tiers already created. You can edit the current ones instead.');

        $tier_data['access_level']= Accesslevel::whereIn('id',array(0,1,2))->get()->toArray();
        ...
        return view('leader.tier.create')->with('tier_data',$tier_data);  
    }
    ...
    public function store(Request $request)
    {
        ...
        $tiers_count = TierList::where('access_level',$request['access_level'])
         ->get()->count();
        $access_level_name = Accesslevel::find($request['access_level'])->access_level_name;
        if($tiers_count == 3)  return redirect('leader/tier')->with('errors','You cannot create for "'.$access_level_name.'". 3 Tiers created already!'); 
      ...
      return redirect('leader/tier')->with('success','Tier created successfully.');
    ...
    public function show($id)
    {
        ...
        //return view('leader.tier.show',compact($tier));
    }
    ...
    public function edit($id)
    {
        ...
        return view('leader.tier.edit',compact('tier'))->with('tier_data',$tier_data);   
     }
    ...
    public function update(Request $request, $id)
    {
     ...
     request()->validate([
      ...
      return redirect('leader/tier')->with('success','Tier updated successfully.');
