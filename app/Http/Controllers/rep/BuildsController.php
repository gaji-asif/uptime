...
class BuildsController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('rep.builds.index',compact('builds'))
    ...
    public function employeeBuild($id)
    {
        ...
        if($employee == 0){
            return redirect()->route('rep.builds.list')->with('errors','Employee not found.');
        }
    ...
    public function create(Request $request)
    {
        ...
        //     Session::save();
        // }
        return view('rep.builds.create')->with('builds_data', $builds_data);
    }
    ...
    public function edit(Builds $builds,$id)
    {
        ...
        //     Session::save();
        // }
        return view('rep.builds.edit',compact('builds'))->with('builds_data', $builds_data);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if(isset($request['challenge']) && $request['challenge'] != '' && $request['challenge'] != '0'){
            if($get_build->challenge_id == $request['challenge']){
                ...
                if($check_chall == 0){
                    ...
                    return redirect()->route('rep.builds.list',['id'=>$id])->with('error','The selected challenge already rejected.');
                }
            }
        }
        ...
        return redirect()->route('rep.builds.list')->with('success','Build updated successfully.');
    }
    ...
    public function destroy(Builds $builds,$id)
    {
        ...
        if($builds && $builds != ''){
            ...
            return redirect()->route('rep.builds.list')->with('error','No builds Found.');
        }
        ...
        //     }
        // }
        return redirect()->route('rep.builds.list')->with('success','Builds Deleted successfully.');
    }
