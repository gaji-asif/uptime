  ...
  public function login(Request $request)
    {
      ...
      if ($check) {
        ...
        switch (Auth::guard('admin')->user()->access_level) {
            case 0:
                   return redirect()->intended('level1.employee.dashboard.home');
                break;
            case 1:
                  return redirect()->intended('level2.employee.dashboard.home');
                break;
            case 2:
                  return redirect()->intended('level3.employee.dashboard.home');
                break;
            case 3:
                return redirect()->intended(route('admin.dashboard'));
                break;
            case 4:
                return redirect()->intended('level4.employee.dashboard.home');
                break;
                
            default:
                 return redirect()->intended('level5.employee.dashboard.home');
                break;
        }
