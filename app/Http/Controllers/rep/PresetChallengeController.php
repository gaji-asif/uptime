...
class PresetChallengeController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('preset_challenge.index',compact('challenge'))
    ...
    public function create()
    {
        ...
        if($user->role == 'admin'){
           ...
           // $challenge_data['access_level_data'] = Accesslevel::where('id','<=',1)->get()->toArray();

//Accesslevel::all();
        return view('preset_challenge.create')->with('challenge_data', $challenge_data);
    }
    ...
    public function show($id)
    {
        if($id && $id > 0){
            ...
            if($challenge){
                ...
                return view('preset_challenge.show',compact('challenge'));
            } else {
...
//Accesslevel::all();
        return view('preset_challenge.edit',compact('challenge'))->with('challenge_data', $challenge_data);
    }
