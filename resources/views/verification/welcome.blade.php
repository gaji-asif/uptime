...
<html lang="en">
  ...
  <main role="main" class="inner cover">
    ...
    <h1 class="cover-heading">Welcome to Uptime</h1>
    <p class="lead"><h5>Where your work is verified</h5></p>
    <p class="lead">
      <br>
      <br>
      <a href="{{ route('verify.submission.authenticate', ['uuid' => $uuid]) }}" class="btn btn-lg btn-secondary">
        Get Started
