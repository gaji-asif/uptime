                      ...
                      @if(isset($images))
                        @foreach($images as $image)
                          <div class="mySlides fades ">
                            <img class="div-img" src="https://uptime-prod.s3-ap-southeast-1.amazonaws.com/images/build/{{$image->image}}">
                            <div class="text" style="text-align: center; margin: 0 auto; margin-left: 7px;"><font style="font-weight: bold;">@if(isset($image->subCategory)){{$image->subCategory->subcategory_name}}@endif </font><br>@if(isset($image->subCategory)){{$image->created_at}}@endif</div>
                          </div>
                        @endforeach
                      @endif
