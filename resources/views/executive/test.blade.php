        ...
        <div class="row">
         ...
         <div class="col-md-6">
                ...
                <div class="col-md-3 my-col-3">
                    ...
                    <input type="text" value="" class="form-control startmonth" name="end_date" data-language='en' id="datetimepicker" required> 
                </div>
                </div>
                <div class="col-md-1"></div>  
              <div class="col-md-3 my-col-3">
              <div class="form-group">
                 ...
                 <input type="text" value="" class="form-control endmonth" name="end_date" data-language='en'  required> 
                </div>
...
//sub category section 
        $.ajax({
              ...
              url: "{{url('executive/check')}}",
              type:'get',
              dataType:'json',
              success: function(result){
                  if(result.status){  
                        //alert(result.message);
                       location.href= "http://uptime.shoecrate.co/executive/test/"+id+"/"+date;
                  }                                                                                                                           
                  else{
 ...
 $('.print-button').click(function(){
     var id = $('.employee_id').val();
     location.href = "http://uptime.shoecrate.co/executive/pdf/"+id;
 });
 //buynow button click 
      ...
      onSelect:function(datetext,inst){
            endmonth = datetext;
             ...
             if(startmonth != '' && startmonth <= endmonth){
                     var id = $('.employee_id').val();
                     location.href= "http://uptime.shoecrate.co/executive/test/"+id+"/"+startmonth+"/"+endmonth;
             }
      }
 }); 
