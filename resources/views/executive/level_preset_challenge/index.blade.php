        ...
        <div class="card-body">
            <div class="row">
                <div class="col-lg-12 margin-tb">
                    <div class="pull-left">
                        <h4 class="theme-color">Manage Preset Challenge</h4>
                    </div>
                    <div class="pull-right">
                        <a class="btn btn-theme margin-bottum-10" href="{{ route('executive.level-preset-challenge.create') }}"> Create Preset Challenge</a>
...
function oderLinsting(){
    ...
    var url = '<?php echo url('executive/employee/level-preset-challenge');?>';
    var durl = '<?php echo url('executive/employee/level-preset-challenge/delete');?>';
    var table = $('#order-listing').DataTable({
        processing: true,
        // serverSide: true,
        ajax: '<?php echo url('executive/employee/level-preset-challenge/challengedatatable');?>',
        "oLanguage": {
            "oPaginate": {
...
$('.delete_pre_challenge').on('click', function(e){
    ...
    var ajaxurl = '<?php echo url('executive/employee/level-preset-challenge/challangedelete');?>';
    if(array.length == 0){
