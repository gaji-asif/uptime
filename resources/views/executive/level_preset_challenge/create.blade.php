...
<div class="content-wrapper">
    ...
    <div class="card col-md-8">
        <div class="card-body">
            ...
            <form action="{{route('executive.level-preset-challenge.store')}}" method="POST" class="forms-sample"  enctype="multipart/form-data">
                @csrf
               ...
               <div class="form-group hide">
                ...
                <div class="form-group">
                    <strong><label>Preset Challenge Image</label></strong>
...
<script type="text/javascript">
 ...
 $('.select_target').change(function(e) {
                 ...
                 form.find('#employee-list').html('');
                  ...
                  if(key != '') {
                    //alert(key);
                    if (key == '3') { // When click on Access Level
                        $.ajax({
                              headers: {
