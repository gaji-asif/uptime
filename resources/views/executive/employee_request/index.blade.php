            ...
            <div class="row">
                ...
                <ul class="nav nav-tabs margin-tb" style="border-bottom: 0px solid #dee2e6;">
                 ...
                 <div class="col-lg-12 margin-tb">
                    <div class="pull-left">
                        <h4 class="theme-color">Manage Employee Requests</h4>
                    </div>
...
function requestLinsting(){ 
    ...
    var ajax_url = '<?php echo url('executive/employee_requests/employeerequestdatatable');?>';
    
   
    var url = '<?php echo url('executive/employee_requests/show');?>';
    var appr_url = '<?php echo url('executive/employee_requests/approve');?>';
    var reject_url = '<?php echo url('executive/employee_requests/reject');?>';
    var table1 = $('#request-listing').DataTable({
        ...
        columns: [
            ...
            return "<a class='btn action-btn btn-outline-info' href="+url+'/'+row['id']+"><i class='fa fa-eye'></i>View</a> <a class='btn action-btn btn-outline-info' href="+appr_url+'/'+row['id']+"><i class='fa fa-eye'></i> Approve</a> <a class='btn action-btn btn-outline-danger trash-button' href="+reject_url+'/'+row['id']+" data-att-name='employee'><i class='fa fa-trash'></i> Reject</a>";
