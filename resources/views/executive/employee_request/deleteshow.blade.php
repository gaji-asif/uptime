        ...
        <div class="card-body">
            ...
            <form action="" method="POST" class="forms-sample">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="full_name" id="full_name" class="form-control" value="{{$employee->full_name}}" placeholder="Full Name" required readonly>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="phone_number" id="phone_number" class="form-control" placeholder="Phone Number" value="{{$employee->phone_number}}" required readonly>
                </div>

                 <div class="form-group">
                    <strong><label for="industry">Region</label></strong>
                    <input type="text" name="region" id="region" class="form-control" value="{{$employee->industry_name}}" required readonly>
                </div>
                ...
                <div class="form-group">
                    <strong><label>Access Level</label></strong>
                     <input type="text" name="accesslevel" id="accesslevel" class="form-control" value="{{$employee->access_name}}" required readonly>
                </div>                        
            </form>
        </div>
    </div>
