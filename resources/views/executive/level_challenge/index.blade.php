            ...
            <div class="row">
                <div class="col-lg-12 margin-tb">
                    ...
                    <div class="pull-right">
                        <a class="btn btn-theme margin-bottum-10" href="{{ route('executive.level-challenge.create') }}"> Create New Challenge</a>
                        <button type="button" class="btn btn-theme margin-bottum-10 delete_challenge">Delete</button>
                    </div>
...
function oderLinsting(){
    ...
    var url = '<?php echo url('executive/employee/level-challenge');?>';
    var durl = '<?php echo url('executive/employee/level-challenge/delete');?>';
    var table = $('#order-listing').DataTable({
        processing: true,
        // serverSide: true,
        ajax: '<?php echo url('executive/employee/level-challenge/challengedatatable');?>',
        "oLanguage": {
            "oPaginate": {
...
$('.delete_challenge').on('click', function(e){
    ...
    var ajaxurl = '<?php echo url('executive/employee/level-challenge/challangedelete');?>';
    if(array.length == 0){
