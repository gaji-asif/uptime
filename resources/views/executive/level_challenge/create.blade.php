...
<div class="content-wrapper">
    ...
    <div class="card col-md-8">
        <div class="card-body">
            <h4 class="card-title theme-color">Add Timed Challenge</h4>
            <form action="{{route('executive.level-challenge.store')}}" method="POST" class="forms-sample"  enctype="multipart/form-data">
                @csrf              

                <div class="form-group">
                    <strong><label for="challenge_text">Timed Challenge Name *</label> </strong>
               ...
               <div class="form-group hide">
                ...
                <div class="form-group">
                    <strong><label>Timed Challenge Image</label></strong>
          ...
          <div class="form-group">
                    ...
                    <input type="text" value="" class="form-control" name="end_date" id="datetimepicker" required>
                </div>
                  ...
                  if(key != ''){
                    $.ajax({
                      headers: {
                       ...
                       url: "{{ url('executive/employee/level-challenge/getregion') }}/"+key,
                      type:'POST',
                      dataType:'json',
                        ...
                        if(result.status){
                 		...
                 		if(region != ''){
		                      ...
		                      headers: {
		                       ...
		                       url: "{{ url('executive/employee/level-challenge/getaccesslevel') }}",
		                      type:'POST',
		                      dataType:'json',
		                      success: function(result){
		                        if(result.status){		                         
		                        ...
		                        if(result.status){		                         
                 				...
                 				if(level!= ''){
				                      ...
				                      headers: {
				                       ...
				                       url: "{{ url('executive/employee/level-challenge/getemployee') }}/"+region+"/"+level,
				                      type:'POST',
				                      dataType:'json',
				                      success: function(result){
				                        if(result.status){	
