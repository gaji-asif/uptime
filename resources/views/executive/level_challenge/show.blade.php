          ...
          <div class="card-body">
            <div class="profile-body">
              <ul class="nav tab-switch" role="tablist">
                <li class="nav-item">
                  <a class="nav-link active" id="user-profile-info-tab" data-toggle="pill" href="#user-profile-info" role="tab" aria-controls="user-profile-info" aria-selected="true">Timed Challenge Detail</a>
                </li>
              </ul>
              <div class="row">
                <div class="col-md-9">
                  <div class="tab-content tab-body" id="profile-log-switch">
                    <div class="tab-pane fade show active pr-3" id="user-profile-info" role="tabpanel" aria-labelledby="user-profile-info-tab">
                      <table class="table table-borderless w-100 mt-4">
                        <tr>
                          <td>Timed Challenge Name :<strong> {{ $challenge->challenge_text }}</strong></td>
                          <td>Status :<strong>
                      ...
                      <div class="extra-link">
                        <a class="btn btn-light btn-fw" href="{{ url('executive/build')}}">View Submission Detail &nbsp;<i class="fa fa-arrow-circle-right"></i></a>
                      </div>
                      @endif
                    </div>
                  </div>
