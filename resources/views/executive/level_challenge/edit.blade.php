...
@if ($errors->any())
    ...
    <div class="card col-md-8">
        <div class="card-body">
        <h4 class="card-title theme-color">Edit Timed Challenge</h4>
        @if(isset($challenge))
            <form action="{{ url('executive/employee/level-challenge/update',$challenge->id) }}" method="post" class="forms-sample"  enctype="multipart/form-data">
                @csrf
