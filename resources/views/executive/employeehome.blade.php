      ...
      <div class="card card-statistics">
        <div class="card-body">
          <div class="d-flex align-items-center justify-content-center">
            ...
            <div class="wrapper">
              <p class="card-text mb-0 theme-color">Total Submissions</p>
              <div class="fluid-container">
  ...
  <div class="row">
      ...
      <div class="card">
        <div class="card-body">
          <div class="d-flex align-items-center justify-content-between mb-4">
            <h5 class="card-title mb-0 theme-color">Submission Wins</h5>
          ...
          <div class="new-accounts">
            <ul class="chats">
              ...
              <li class="chat-persons">
                <a href="{{url('executive/employee/buildshow/'.$wbuild->id)}}">
                  <span class="pro-pic">
                  <img src="<?php echo \Storage::disk('s3')->url('images/build/'.$wbuild->image);?>" onerror="this.src='<?php echo \Storage::disk('s3')->url('images/no_image.png'); ?>'">
                  </span>
                  <div class="user">
    ...
    <div class="col-md-3 grid-margin stretch-card">
      <div class="card">
        <div class="card-body">
          <div class="d-flex align-items-center justify-content-between mb-4">
            <h5 class="card-title mb-0 theme-color">Submission Losses</h5>
            <small class="text-gray d-none d-sm-block"></small>
          </div>
          <div class="new-accounts">
            <ul class="chats">
              ...
              <li class="chat-persons">
                <a href="{{url('executive/employee/buildshow/'.$lbuild->id)}}">
                  <span class="pro-pic">
                  <img src="<?php echo \Storage::disk('s3')->url('images/build/'.$lbuild->image);?>" onerror="this.src='<?php echo \Storage::disk('s3')->url('images/no_image.png'); ?>'">
                  </span>
                  <div class="user">
    ...
    <div class="col-md-3 grid-margin stretch-card">
      <div class="card">
        <div class="card-body">
          <div class="d-flex align-items-center justify-content-between mb-4">
            <h5 class="card-title mb-0 theme-color">Active Submissions</h5>
            <small class="text-gray d-none d-sm-block"></small>
          </div>
          <div class="new-accounts">
            <ul class="chats">
              ...
              <li class="chat-persons">
                <a href="{{url('executive/employee/buildshow/'.$cbuild->id)}}">
                  <span class="pro-pic">
                  <img src="<?php echo \Storage::disk('s3')->url('images/build/'.$cbuild->image);?>" onerror="this.src='<?php echo \Storage::disk('s3')->url('images/no_image.png'); ?>'">
                  </span>
                  <div class="user">
        ...
        <div class="card-body">
          ...
          <div class="new-accounts">
            <ul class="chats">
              ...
              <li class="chat-persons">
                <a href="{{url('executive/employee/level-challenge/'.$challenge['id'])}}">
                  <span class="pro-pic">
                  <img src="<?php echo \Storage::disk('s3')->url('images/challenge/'.$challenge['image']);?>" onerror="this.src='<?php echo \Storage::disk('s3')->url('images/no_image.png'); ?>'">
                  </span>
                  <div class="user">
