...
<div class="content-wrapper">
    ...
    <div class="card col-md-8">
        <div class="card-body">
            ...
            <form action="{{ route('upload.store') }}" method="POST" class="forms-sample"  enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <strong><label for='company'>Region </label></strong>
                    
                    <dl class='dropdown form-control'>        
                 
                       <dt><a href='#'><span class='multiSel'>Select Region</span></a></dt>     
                        <dd>
