...
<div class="content-wrapper">
    ...
    <div class="card col-md-8">
        <div class="card-body">
        <h4 class="card-title theme-color">Edit Submission</h4>
        @if(isset($builds))
            <form action="{{ url('executive/builds/update',$builds->id) }}" method="POST" class="forms-sample"  enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <select class="form-control build-category-add" name="category" id="category_id" required data-id="{{$builds->id}}">
