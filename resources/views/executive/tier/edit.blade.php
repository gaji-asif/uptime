...
<div class="content-wrapper">
    ...
    <div class="card col-md-8">
        ...
        <h4 class="card-title theme-color">Edit Tier</h4>
            ...
            <form action="{{ url('/executive/tier/update',$tier->id) }}" method="POST" class="forms-sample"  enctype="multipart/form-data">
                @csrf
                ...
                <div class="row subcategory-layer">
                    <div class="subcat">
                         ...
                         <div class ="input-box-layer" >
                            <input type="number" name="uploads" id="uploads" min = "0" class="input-box" value="{{$tier->uploads}}" placeholder="Number of Uploads" required>
                         </div>
                    </div>
                     ...
                     <div class="subcat">
                         ...
                         <div class ="input-box-layer" >
                            <input type="number" name="challenges" id="challenges"  min = "0" class="input-box" value="{{$tier->challenges}}" placeholder="Number of Challenges" required>
                         </div>
                     </div>
                 </div>
               </div>
        ...
        getsubcategory();
         ...
         $('#access_level').change(function(e){
                ...
                if(level != ''){
                        ...
                        url: base_url+"/executive/tier/getsubcategory/"+level,
                        type:'POST',
                        dataType:'json',
    ...
    function getsubcategory(){
        var id = $("#listid").val();
         ...
         $.ajax({
                        ...
                        url: base_url+"/executive/tier/getsubcategoryfromid/"+id,
                        type:'POST',
                        dataType:'json',
                        success: function(result){
                          if(result.status){
