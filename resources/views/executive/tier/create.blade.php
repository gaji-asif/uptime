...
<div class="content-wrapper">
    ...
    @if($errors->any())
        <div class=" alert alert-danger">
            <strong>Whoops!</strong>You cannot create Tier.3 Tiers Already Created.<br><br>
        </div>
    @endif
    ...
    <div class="card col-md-8">
        <div class="card-body">
        <h4 class="card-title theme-color">Create New  Tier</h4>
        
            <form action="{{ url('/executive/tier/store')}}" method="POST" class="forms-sample"  enctype="multipart/form-data">
                @csrf
            ...
            <div  class="form-group">
                ...
                <div class="row subcategory-layer">
                  ...
                  <div class="form-group">
                    <strong><label id = "points-title" for="points">{{$tier_data['point_title']}}</label> </strong>
                    <input type="number" name="points" id="points"  min = "0" class="form-control" value="0" placeholder="Number of Points Prize" required>
                 </div>
