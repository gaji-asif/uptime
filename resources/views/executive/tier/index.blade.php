            ...
            <div class="row">
                <div class="col-lg-12 margin-tb">
                    ...
                    <div class="pull-right">
                        <a class="btn btn-theme margin-bottum-10" href="{{ url('executive/tier/create') }}"> Create New Tier</a>
...
function oderLinsting(){
    ...
    var ajax_url = '<?php echo url('executive/tier/tierdatatable');?>';
    var url = '<?php echo url('executive/tier');?>';
    var durl = '<?php echo url('executive/tier/delete');?>';
...
$('.delete_tier').on('click', function(e){
    ...
    var ajaxurl = '<?php echo url('executive/tier/destroy');?>';
    if(array.length == 0){
