            ...
            <div class="row">
                <div class="col-lg-12 margin-tb">
                    ...
                    <div class="pull-right">
                        <a class="btn btn-theme margin-bottum-10" href="{{ url('executive/users/create') }}"> Create New Company</a>
                    </div>
                </div>
            </div>
...
function oderLinsting(){
    ...
    $('#order-listing').DataTable({
        processing: true,
        // "lengthMenu": [[1,25, 50, 75, -1], [1,25, 50, 75, "All"]],
        serverSide: true,
        ajax: '<?php echo url('executive/users/userdatatable');?>',
        "oLanguage": {
            "oPaginate": {
