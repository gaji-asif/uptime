...
function oderLinsting(){
    ...
    var ajax_url = '<?php echo url('employee/tenure/tenuredatatable');?>';
    if(call_from == '1'){
        var ajax_url = '<?php echo url('employee/tenure/employee-data/'.$tenure->employee_id);?>';
    }

    var url = '<?php echo url('employee/tenure');?>';
    var durl = '<?php echo url('employee/tenure/delete');?>';
    var employee_show = '<?php echo url('employee');?>';
...
$('.delete_tenure').on('click', function(e){
    ...
    var ajaxurl = '<?php echo url('employee/tenure/tenuredelete');?>';
    if(array.length == 0){
