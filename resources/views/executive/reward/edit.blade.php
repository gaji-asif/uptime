...
<div class="content-wrapper">
    ...
    <div class="card col-md-8">
        ...
        <h4 class="card-title theme-color">Edit Reward</h4>
           <form action="{{url('executive/reward/'.$reward->id.'/update')}}" method="POST" class="forms-sample"  enctype="multipart/form-data">
                @csrf
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" name="point" id="point" value="{{$reward->point}}" required>
                    </div>
