...
function oderLinsting(){
    ...
    var ajax_url = '<?php echo url('executive/tenure/tenuredatatable');?>';
    if(call_from == '1'){
        var ajax_url = '<?php echo url('executive/tenure/employee-data/'.$tenure->employee_id);?>';
    }
     
    var url = '<?php echo url('executive/tenure');?>';
    var durl = '<?php echo url('executive/tenure/delete');?>';
    var employee_show = '<?php echo url('executive/employee');?>';
...
$('.delete_tenure').on('click', function(e){
    ...
    var ajaxurl = '<?php echo url('executive/tenure/tenuredelete');?>';
    if(array.length == 0){
