                        ...
                        <div class="tab-pane fade show active pr-3" id="user-profile-info" role="tabpanel" aria-labelledby="user-profile-info-tab">
                          ...
                          <table class="table table-borderless w-100 mt-4">
                            ...
                            <tr>
                              ...
                              <td>Store :<strong> {{ $employee->industry }}</strong></td>
                            </tr>
                            <tr>
                            ...
                            <!-- <tr>
                              <td>Total Submission :<strong> <label class="badge badge-success">{{ $employee->build }}</label></strong></td>
                 ...
                 <div class="col-md-3">
                  ...
                  <div class="row">
                    <div class="extra-link col-md-3">
                      <a class="btn btn-light btn-fw" href="{{ url('executive/users',$employee->company_id) }}">View company detail &nbsp;<i class="fa fa-arrow-circle-right"></i></a>
                    </div>
                       @if($employee->build != 0)
                    <div class="extra-link col-md-3">
                      <a class="btn btn-light btn-fw" href="<?PHP echo url('executive/builds/employee/'.$employee->id) ;?>">View Submission list &nbsp;<i class="fa fa-arrow-circle-right"></i></a>
                    </div>
                    @endif
                    ...
                    <div class="extra-link col-md-3">
                      <a class="btn btn-light btn-fw" href="<?PHP echo url('executive/validations/employee/'.$employee->id) ;?>">View Validation list &nbsp;<i class="fa fa-arrow-circle-right"></i></a>
                    </div>
                    @endif
                    
                    <div class="extra-link col-md-3">
                      <a class="btn btn-light btn-fw" href="<?PHP echo url('executive/tenure/employee/'.$employee->id) ;?>">View Tenure &nbsp;<i class="fa fa-arrow-circle-right"></i></a>
                    </div>
                  </div>
                </div>
                ...
                <div class="tab-pane fade active show" id="eProfile" role="tabpanel" aria-labelledby="profile-tab">
                  ...
                  <div class="col-md-12">
                      ...
                      <div class="col-md-2 text-center fltleft">
                          ...
                          <div class="details">
                              <a href="{{url('executive/employee/status/'.$employee->id.'/1')}}"  target="_blank"><button class="btn btn-success">More Details</button></a>
                          </div>
                      </div>
                      <div class="col-md-2 text-center fltleft">
                          <div class="round">
                          ...
                          <div class="details">
                              <a href="{{url('executive/employee/status/'.$employee->id.'/0')}}" target="_blank"><button class="btn btn-danger">More Details</button></a>
                          </div>
                      </div>
                  </div>
                  ...
                  <div class="col-md-12 fltleft">
                      ...
                      <div class="col-md-2 text-center fltleft">
                          ...
                          <div class="details">
                             <!-- <a href="{{url('executive/employee/downloadresume/'.$employee->id)}}" target="_blank"><button class="btn btn-warning">Profile PDF</button></a>-->
                             <a href="{{ url('executive/test/'.$employee->id.'/'.\Carbon\Carbon::parse($employee->created_at)->format('m-d-Y').'/'.\Carbon\Carbon::today()->format('m-d-Y')) }}"><button class="btn btn-warning">Profile PDF</button></a> 
                          </div>
                      </div>
                      <div class="col-md-2 text-center fltleft">
                          <div class="squre">
                          ...
                          <div class="details">
                              <button class="btn btn-danger" data-toggle="modal" data-target="#dailyModal">Challenges</button>
                          </div>
                      </div>
                  </div>
                </div>
...
<div id="dailyModal" class="modal fade" role="dialog">
  <div class="modal-dialog modal-md">
    ...
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title">Challenge Wins</h4>
      </div>
      <div class="modal-body">
        <?php
          if(!empty($challangeiesByEid)){
            echo '<table class="table"><thead><tr><th>Main Category</th><th>Win Count</th></tr></thead>';
            foreach($challangeiesByEid as $item){
              echo '<tbody><tr><td>'.$item['maincat_name'].'</td><td>'.$item['count'].'</td></tr></tbody>';
            }
            echo '</table>';
          }else{
...
<div id="allcategories" class="modal fade" role="dialog">
  <div class="modal-dialog modal-md">
    ...
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title">Submissions Approved</h4>
      </div>
      <div class="modal-body">
         <?php
          if(!empty($maincategory_data)){
            echo '<table class="table"><thead><tr><th>Sub Category</th><th>Win Count</th></tr></thead>';
              $i = 0 ;
            foreach($maincategory_data as $key => $cat){
              
              echo '<tr class="breakrow"><td><h5>'.$key.'</h5></td><td><h5>'.$cat.'</h5></td></tr>';
                
              foreach ($subcategory_data[$i] as $key1 => $value) {
                  echo '<tr class="datarow" style="padding-top:-1%;"><td>'.$key1.'</td><td>'.$value.'</td></tr>';
              }
              $i++;
