            ...
            <div class="row">
                <div class="col-lg-12 margin-tb">
                    ...
                    <div class="pull-right">
                        <a class="btn btn-theme margin-bottum-10" href="{{ route('executive.employee.employeecreate') }}"> Create New Employee</a>
...
function oderLinsting(){
    ...
    var url = '<?php echo url('executive/employee/employeelist');?>';
    var urledit = '<?php echo url('executive/employee');?>';
    var url2 = '<?php echo url('executive/employee/showuser');?>';    
    var durl = '<?php echo url('executive/employee/delete');?>';
...
$('.delete_emp').on('click', function(e){
    ...
    var ajaxurl = '<?php echo url('executive/employee/employeedelete');?>';
    if(array.length == 0){
