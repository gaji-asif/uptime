...
$('.delete_challenge').on('click', function(e){
    ...
    var ajaxurl = '<?php echo url('executive/challenge/challangedelete');?>';
    if(array.length == 0){
...
function requestLinsting(){ 
    ...
    var ajax_url2 = '<?php echo url('executive/employee/challenge requests/challengerequestdatatable');?>';
    /*if(call_from == '1'){
    ...
    var aurl = '<?php echo url('executive/employee/approve-request-challenge/');?>';
