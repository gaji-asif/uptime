...
<div class="content-wrapper">
    ...
    <div class="card col-md-8">
        <div class="card-body">
            ...
            <form action="{{ url('leader/employee/categories/update/'.request()->segment(count(request()->segments()))) }}" method="POST" class="forms-sample">
                @csrf
               <!--  <div class="form-group">
                    <strong><label for="sub_category_name">Sub Category Name *</label> </strong>
                    <input type="text" name="sub_category_name" id="sub_category_name" class="form-control" value="<?php if(!empty($categories_data['sub_category'])) { echo $categories_data['sub_category']['subcategory_name']; } ?>" placeholder="Sub Category Name" required disabled>
                </div> -->
