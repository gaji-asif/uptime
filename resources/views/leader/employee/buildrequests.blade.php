...
function requestLinsting(){ 
    ...
    var ajax_url2 = '<?php echo url('leader/employee/build requests/buildsrequestdatatable');?>';
    
   
    var url1 = '<?php echo url('leader/employee/buildshow');?>';
    var aurl = '<?php echo url('leader/employee/approve-request');?>';
    var viewurl = '<?php echo url('leader/employee/view-request');?>';
