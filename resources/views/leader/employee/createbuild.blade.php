...
<div class="content-wrapper">
    ...
    <div class="card col-md-8">
        <div class="card-body">
            ...
            <form action="{{route('leader.employee.builds.storebuild')}}" method="POST" class="forms-sample"  enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group">
                    <strong><label for="category_id">Main Category Name *</label></strong>
