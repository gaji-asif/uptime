                 ...
                 <div class="col-md-3">
                  ...
                  <div class="row">
                    <div class="extra-link col-md-3">
                      <a class="btn btn-light btn-fw" href="{{ url('leader/users',$employee->company_id) }}">View company detail &nbsp;<i class="fa fa-arrow-circle-right"></i></a>
                    </div>
                       @if($employee->build != 0)
                    <div class="extra-link col-md-3">
                      <a class="btn btn-light btn-fw" href="<?PHP echo url('leader/builds/employee/'.$employee->id) ;?>">View Build list &nbsp;<i class="fa fa-arrow-circle-right"></i></a>
                    </div>
                    @endif
                    ...
                    <div class="extra-link col-md-3">
                      <a class="btn btn-light btn-fw" href="<?PHP echo url('leader/validations/employee/'.$employee->id) ;?>">View Validation list &nbsp;<i class="fa fa-arrow-circle-right"></i></a>
                    </div>
                    @endif
                    
                    <div class="extra-link col-md-3">
                      <a class="btn btn-light btn-fw" href="<?PHP echo url('leader/tenure/employee/'.$employee->id) ;?>">View Tenure &nbsp;<i class="fa fa-arrow-circle-right"></i></a>
                    </div>
                  </div>
                </div>
                ...
                <div class="tab-pane fade active show" id="eProfile" role="tabpanel" aria-labelledby="profile-tab">
                  ...
                  <div class="col-md-12">
                      ...
                      <div class="col-md-2 text-center fltleft">
                          ...
                          <div class="details">
                              <a href="{{url('leader/employee/status/'.$employee->id.'/1')}}"  target="_blank"><button class="btn btn-success">More Details</button></a>
                          </div>
                      </div>
                      <div class="col-md-2 text-center fltleft">
                          <div class="round">
                          ...
                          <div class="details">
                              <a href="{{url('leader/employee/status/'.$employee->id.'/0')}}" target="_blank"><button class="btn btn-danger">More Details</button></a>
                          </div>
                      </div>
                  </div>
                  ...
                  <div class="col-md-12 fltleft">
                     ...
                     <!-- <div class="col-md-2 text-center fltleft">
                          ...
                          <div class="details">
                              <a href="{{url('leader/employee/downloadresume/'.$employee->id)}}" target="_blank"><button class="btn btn-warning">Profile PDF</button></a>
                          </div>
                      </div>
                      -->
...
<div id="allcategories" class="modal fade" role="dialog">
  <div class="modal-dialog modal-md">
    ...
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title">Categories Validated</h4>
      </div>
      <div class="modal-body">
        <?php
          if(!empty($categoriesByEid)){
            echo '<table class="table"><thead><tr><th>Main Categories</th><th>Win Count</th></tr></thead>';
            foreach($categoriesByEid as $key => $cat){
              echo '<tr><td>'.$key.'</td><td>'.$cat.'</td></tr>';
