...
$('.delete_challenge').on('click', function(e){
    ...
    var ajaxurl = '<?php echo url('leader/challenge/challangedelete');?>';
    if(array.length == 0){
...
function requestLinsting(){ 
    ...
    var ajax_url2 = '<?php echo url('leader/employee/challenge requests/challengerequestdatatable');?>';
    /*if(call_from == '1'){
    ...
    var url1 = '<?php echo url('leader/employee/buildshow');?>';
    var aurl = '<?php echo url('leader/employee/approve-request-challenge/');?>';
