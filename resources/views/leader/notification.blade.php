...
<div class="content-wrapper">
    ...
    <div class="card col-md-8 form-group">
        <div class="card-body">
            ...
            <form action="{{ url('leader/sendnotification') }}" autocomplete="nope" method="POST" class="forms-sample" enctype="multipart/form-data">
                @csrf
   ...
   $('.change-notification').change(function(e) {
    ...
    if(key != ''){
      $.ajax({
        ...
        url: base_url+"/leader/users/get-notification-role/"+key,
        type:'POST',
        dataType:'json',
            ...
            $('.employee-region').change(function(e) {
                ...
                if(region != ''){
                  ...
                  $.ajax({
                    ...
                    url: base_url+"/leader/users/get-access-level-users",
                    type:'POST',
                    dataType:'json',
                    success: function(result){
                        ...
                        $('.employee-level').change(function(e) {
                                ...
                                if(level != ''){
                                  ...
                                  $.ajax({
                                    ...
                                    url: base_url+"/leader/users/get-notification-employee/"+region+"/"+level,
                                    type:'POST',
                                    dataType:'json',
                                    success: function(result){
