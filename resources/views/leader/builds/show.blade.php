                ...
                <div class="col-md-4">
                    ...
                    <div class="tab-pane fade show active pr-3" id="user-profile-info" role="tabpanel" aria-labelledby="user-profile-info-tab">
                      ...
                      <div class="extra-link">
                        <a class="btn btn-light btn-fw" href="{{ url('leader/employee/showuser',$builds->employee_id)}}">View employee Detail &nbsp;<i class="fa fa-arrow-circle-right"></i></a>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row">
                   ...
                   @if($builds->challenge_image != '')
                    ...
                    <div class="col-md-6 " >
                      ...
                      <img src="<?php echo \Storage::disk('s3')->url('images/challenge/'.$builds->challenge_image);?>" alt="challenge_image" width="200px" height = "200px" onerror="this.src='<?php echo url('images/no_image.png'); ?>'">
                      
                      
                      </div>
                      <br>
                    <p>Description :<strong> {{ $builds->challenge_name }}</strong></p>
                      <p>created At :<strong> {{ $builds->challenge_created_at}}</strong></p>
                    </div> 
                      @endif 
                      <div class="col-md-6">
                        ...
                        <br>
                           <p>Description :<strong> {{ $builds->build_text}}</strong></p>
                            <p>created At :<strong> {{ $builds->newdate}}</strong></p>
                      </div>
