      ...
      <div class="card card-statistics">
        <div class="card-body">
          <div class="d-flex align-items-center justify-content-center">
            ...
            <div class="wrapper">
              <a href="{{ route('leader.categories.list') }}"><p class="card-text mb-0">Total Categories</p></a>
      ...
      <div class="card card-statistics">
        <div class="card-body">
          <div class="d-flex align-items-center justify-content-center">
            ...
            <div class="wrapper">
              <a href="{{ route('leader.employee.list') }}"><p class="card-text mb-0 theme-color">Total Employees</p></a>
              <div class="fluid-container">
      ...
      <div class="card card-statistics">
        <div class="card-body">
          <div class="d-flex align-items-center justify-content-center">
            ...
            <div class="wrapper">
              <a href="{{ url('leader/employee/build/list') }}"><p class="card-text mb-0 theme-color">Total Submissions</p></a>
              <div class="fluid-container">
      ...
      <div class="card card-statistics">
        <div class="card-body">
          <div class="d-flex align-items-center justify-content-center">
            ...
            <div class="wrapper">
              <a href="{{ route('leader.level-challenge.list') }}"><p class="card-text mb-0 theme-color">Total Challenges</p></a>
              <div class="fluid-container">
          ...
          <div class="new-accounts">
            <ul class="chats">
              ...
              <li class="chat-persons">
                <a href="{{url('leader/employee/buildshow/'.$wbuild->id)}}">
                  <span class="pro-pic">
        ...
        <div class="card-body">
          ...
          <div class="new-accounts">
            <ul class="chats">
              ...
              <li class="chat-persons">
                <a href="{{url('leader/employee/buildshow/'.$lbuild->id)}}">
                  <span class="pro-pic">
        ...
        <div class="card-body">
          ...
          <div class="new-accounts">
            <ul class="chats">
              ...
              <li class="chat-persons">
                <a href="{{url('leader/employee/buildshow/'.$cbuild->id)}}">
                  <span class="pro-pic">
        ...
        <div class="card-body">
          ...
          <div class="new-accounts">
            <ul class="chats">
              ...
              <li class="chat-persons">
                <a href="{{url('leader/employee/level-challenge/'.$challenge['id'])}}">
                  <span class="pro-pic">
