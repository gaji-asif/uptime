            ...
            <div class="row">
                <div class="col-lg-12 margin-tb">
                    ...
                    <div class="pull-right">
                        <a class="btn btn-theme margin-bottum-10" href="{{ route('leader.employee.industrycreate') }}"> Create New Region</a>
                    </div>
                </div>
            </div>
            <div class="row">
...
function oderLinsting(){
    ...
    var url = '<?php echo url('leader/employee/industry');?>';
    var durl = '<?php echo url('leader/employee/industry/delete');?>';
    ...
    $('#order-listing').DataTable({
        processing: true,
        serverSide: true,
        ajax: '<?php echo url('leader/employee/industry/industrydatatable');?>',
        "oLanguage": {
            "oPaginate": {
