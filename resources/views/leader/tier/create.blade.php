...
<div class="content-wrapper">
    ...
    @if ($errors->any())
        <div class=" alert alert-danger">
            <strong>Whoops!</strong>You can't create Tier.3 Tiers Already Created.<br><br>
        </div>
    @endif
    ...
    <div class="card col-md-8">
        ...
        <h4 class="card-title theme-color">Create New  Tier</h4>
            ...
            <form action="{{ url('/leader/tier/store')}}" method="POST" class="forms-sample"  enctype="multipart/form-data">
                @csrf
