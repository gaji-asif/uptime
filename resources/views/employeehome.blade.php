      ...
      <div class="card card-statistics">
        <div class="card-body">
          <div class="d-flex align-items-center justify-content-center">
            ...
            <div class="wrapper">
              <a href="{{ url('/employee/categories') }}"><p class="card-text mb-0">Total Categories</p></a>
      ...
      <div class="card card-statistics">
        <div class="card-body">
          <div class="d-flex align-items-center justify-content-center">
            ...
            <div class="wrapper">
              <a href="{{ url('employee/list') }}"><p class="card-text mb-0 theme-color">Total Employees</p></a>
              <div class="fluid-container">
      ...
      <div class="card card-statistics">
        <div class="card-body">
          <div class="d-flex align-items-center justify-content-center">
            ...
            <div class="wrapper">
              <a href="{{ url('/employee/build') }}"><p class="card-text mb-0 theme-color">Total Builds</p></a>
              <div class="fluid-container">
      ...
      <div class="card card-statistics">
        <div class="card-body">
          <div class="d-flex align-items-center justify-content-center">
            ...
            <div class="wrapper">
              <a href="{{ url('/employee/challenge') }}"><p class="card-text mb-0 theme-color">Total Challenges</p></a>
              <div class="fluid-container">
