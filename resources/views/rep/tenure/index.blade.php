...
function oderLinsting(){
    ...
    var ajax_url = '<?php echo url('rep/tenure/tenuredatatable');?>';
    if(call_from == '1'){
        var ajax_url = '<?php echo url('rep/tenure/employee-data/'.$tenure->employee_id);?>';
    }
     
    var url = '<?php echo url('rep/tenure');?>';
    var durl = '<?php echo url('rep/tenure/delete');?>';
    var employee_show = '<?php echo url('rep/employee');?>';
...
$('.delete_tenure').on('click', function(e){
    ...
    var ajaxurl = '<?php echo url('rep/tenure/tenuredelete');?>';
    if(array.length == 0){
