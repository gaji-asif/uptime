            ...
            <div class="row">
                <div class="col-lg-12 margin-tb">
                    ...
                    <div class="pull-right">
                        <a class="btn btn-theme margin-bottum-10" href="{{ route('rep.employee.employeecreate') }}"> Create New Employee</a>
...
function oderLinsting(){
    ...
    var ajax_url = '<?php echo url('rep/employee/useremployeedatatable');?>';
    var url = '<?php echo url('rep/employee/employeelist');?>';
    var urledit = '<?php echo url('rep/employee');?>';
    var url2 = '<?php echo url('rep/employee/showuser');?>';    
    var durl = '<?php echo url('rep/employee/delete');?>';
...
$('.delete_emp').on('click', function(e){
    ...
    var ajaxurl = '<?php echo url('rep/employee/employeedelete');?>';
    if(array.length == 0){
