...
<!--             <form action="{{ url('employee/updatebuild/') }}" method="POST" class="forms-sample"  enctype="multipart/form-data"> -->
            <form action="{{ url('rep/employee/build/updatebuild') }}" method="POST" class="forms-sample"  enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control buil-category-add" name="category" id="category" required data-id="{{$builds->id}}">
