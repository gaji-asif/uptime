            ...
            <div class="row">
                ...
                <div class="col-lg-12 margin-tb">
                    ...
                    <!-- <div class="pull-right">
                        <a class="btn btn-theme margin-bottum-10" href="{{ route('rep.employee.builds.createbuild') }}"> Create New Submission</a>
...
function oderLinsting(){
    ...
    var ajax_url = '<?php echo url('rep/employee/build/buildsdatatable');?>';
    
   
    var url = '<?php echo url('rep/employee/buildshow');?>';
    var durl = '<?php echo url('rep/employee/builds/delete');?>';
    var eurl = '<?php echo url('rep/employee/edit-build');?>';
...
$('.delete_build').on('click', function(e){
    ...
    var ajaxurl = '<?php echo url('rep/employee/builds/builddelete');?>';
