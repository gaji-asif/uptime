...
function requestLinsting(){ 
    ...
    var ajax_url2 = '<?php echo url('rep/employee/build requests/buildsrequestdatatable');?>';
    
   
    var url1 = '<?php echo url('rep/employee/buildshow');?>';
    var aurl = '<?php echo url('rep/employee/approve-request');?>';
    var viewurl = '<?php echo url('rep/employee/view-request');?>';
