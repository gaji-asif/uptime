...
<div class="content-wrapper">
    ...
    <div class="card col-md-8">
        <div class="card-body">
            ...
            <form action="{{ route('employee.update',$employee->id) }}" method="POST" class="forms-sample" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <div class="form-group {{($employee_data['categories'] ? '' : 'hide')}}">
                    ...
                    <select class="form-control" name="industry" id="industry">
                        ...
                        @foreach ($employee_data['categories'] as $cat)
                            <option value="{{$cat['id']}}" {{$employee->industry == $cat['id'] ? 'selected' : ''}}>{{$cat['category_name']}}</option>
                        @endforeach
                    </select>
                </div>
                ...
                @if($employee_data['is_admin'] == 1 && $employee_data['users'] || $employee_data['is_admin'] == 0)
