...
$('.delete_challenge').on('click', function(e){
    ...
    var ajaxurl = '<?php echo url('rep/challenge/challangedelete');?>';
    if(array.length == 0){
...
function requestLinsting(){ 
    ...
    var ajax_url2 = '<?php echo url('rep/employee/challenge requests/challengerequestdatatable');?>';
    /*if(call_from == '1'){
    ...
    var url1 = '<?php echo url('rep/employee/buildshow');?>';
    var aurl = '<?php echo url('rep/employee/approve-request-challenge/');?>';
