            ...
            <div class="row">
                <div class="col-lg-12 margin-tb">
                   ...
                   <!--  <div class="pull-right">
                        <a class="btn btn-theme margin-bottum-10" href="{{ route('rep.employee.categories.create')  }}"> Create New Sub Category</a>
                    </div> -->
                </div>
            </div>
            <div class="row">
...
function oderLinsting(){
    ...
    var url = '<?php echo url('rep/employee/categories');?>';
    var durl = '<?php echo url('rep/employee/categories/delete');?>';
    var users_show = '<?php echo url('users');?>';
    $('#order-listing').DataTable({
        processing: true,
        serverSide: true,
        ajax: '<?php echo url('rep/employee/categories/categorydatatable');?>',
        "oLanguage": {
            "oPaginate": {
