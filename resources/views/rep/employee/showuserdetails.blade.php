               ...
               <div class="tab-pane fade" id="eInfo" role="tabpanel" aria-labelledby="home-tab">
                  ...
                  <div class="row">
                    <div class="extra-link col-md-3">
                      <a class="btn btn-light btn-fw" href="{{ url('rep/users',$employee->company_id) }}">View company detail &nbsp;<i class="fa fa-arrow-circle-right"></i></a>
                    </div>
                     @if($employee->build != 0)
                    <div class="extra-link col-md-3">
                      <a class="btn btn-light btn-fw" href="<?PHP echo url('rep/builds/employee/'.$employee->id) ;?>">View Build list &nbsp;<i class="fa fa-arrow-circle-right"></i></a>
                    </div>
                    @endif
                  @if($employee->validation != 0)
                    <div class="extra-link col-md-3">
                      <a class="btn btn-light btn-fw" href="<?PHP echo url('rep/validations/employee/'.$employee->id) ;?>">View Validation list &nbsp;<i class="fa fa-arrow-circle-right"></i></a>
                    </div>
                    @endif
                   
                    <div class="extra-link col-md-3">
                      <a class="btn btn-light btn-fw" href="<?PHP echo url('rep/tenure/employee/'.$employee->id) ;?>">View Tenure &nbsp;<i class="fa fa-arrow-circle-right"></i></a>
                    </div>
                  </div>
                </div>
                ...
                <div class = "col-md-3 emp-detail-name">
                <br>
                 <h4>  {{ $employee->full_name }}</h4>
                  ...
                  <div class="col-md-12">
                      ...
                      <div class="col-md-2 text-center fltleft">
                          ...
                          <div class="details">
                              <a href="{{url('rep/employee/status/'.$employee->id.'/1')}}"  target="_blank"><button class="btn btn-success">More Details</button></a>
                          </div>
                      </div>
                      <div class="col-md-2 text-center fltleft">
                          <div class="round">
                          ...
                          <div class="details">
                              <a href="{{url('rep/employee/status/'.$employee->id.'/0')}}" target="_blank"><button class="btn btn-danger">More Details</button></a>
                          </div>
                      </div>
                  </div>
                  ...
                  <div class="col-md-12 fltleft">
                      ...
                      <div class="col-md-2 text-center fltleft">
                          ...
                          <div class="details">
                              <a href="{{url('rep/employee/downloadresume/'.$employee->id)}}" target="_blank"><button class="btn btn-warning">Daily Achievement</button></a>
                          </div>
                      </div>
                      <div class="col-md-2 text-center fltleft">
                          <div class="squre">
