            ...
            <div class="row">
                <div class="col-lg-12 margin-tb">
                    ...
                    <div class="pull-right">
                        <a class="btn btn-theme margin-bottum-10" href="{{ route('challenge.create') }}"> Create New Challenge</a>
...
function oderLinsting(){
    ...
    var url = '<?php echo url('challenge');?>';
    var durl = '<?php echo url('challenge/delete');?>';
    var table = $('#order-listing').DataTable({
        processing: true,
        serverSide: true,
        ajax: '<?php echo url('challenge/challengedatatable');?>',
        "oLanguage": {
            "oPaginate": {
