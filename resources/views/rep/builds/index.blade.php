            ...
            <div class="row">
                <div class="col-lg-12 margin-tb">
                    ...
                    <div class="pull-right">
                        <a class="btn btn-theme margin-bottum-10" href="{{ url('rep/builds/create') }}"> Create New Build</a>
...
function oderLinsting(){
    ...
    var ajax_url = '<?php echo url('rep/builds/buildsdatatable');?>';
    if(call_from == '1'){
        var ajax_url = '<?php echo url('rep/builds/employee-data/'.$builds->employee_id);?>';
    }else if(call_from == '2'){
        var ajax_url = '<?php echo url('rep/builds/employeestatusajax/'.$builds->employee_id.'/'.$builds->employee_g_status);?>';
    }

    var url = '<?php echo url('rep/builds');?>';
    var durl = '<?php echo url('rep/builds/delete');?>';
...
$('.delete_build').on('click', function(e){
    ...
    var ajaxurl = '<?php echo url('rep/builds/builddelete');?>';
    if(array.length == 0){
