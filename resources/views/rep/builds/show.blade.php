                ...
                <div class="col-md-4">
                    ...
                    <div class="tab-pane fade show active pr-3" id="user-profile-info" role="tabpanel" aria-labelledby="user-profile-info-tab">
                      ...
                      <div class="extra-link">
                        <a class="btn btn-light btn-fw" href="{{ url('rep/employee/showuser',$builds->employee_id)}}">View employee Detail &nbsp;<i class="fa fa-arrow-circle-right"></i></a>
                      </div>
                    </div>
                  </div>
                   ...
                   @if($builds->challenge_image != '')
                    ...
                    <p>Description :<strong> {{ $builds->challenge_name }}</strong></p>
                      ...
                      <div class="col-md-6">
                        ...
                        <div class="new-accounts user-detail-image">
                          @if($builds->image != '')
                          <img src="<?php echo \Storage::disk('s3')->url('images/build/'.$builds->image);?>" alt="Build image" width="200px" height = "200px" onerror="this.src='<?php echo url('images/no_image.png'); ?>'">
                          @else
