...
<div class="content-wrapper">
    ...
    <div class="card col-md-8">
        <div class="card-body">
            <h4 class="card-title theme-color">Add New Validationwerer</h4>
            <form action="{{ route('employee-validations.store') }}" method="POST" class="forms-sample">
                @csrf

                @if($validations_data['builds'])
                <div class="form-group">
                    <strong><label for="build_id">Build Name *</label></strong>
                    <select class="form-control get-employee-from-build_emp" name="build" id="build_id" required>
                ...
                <input type="hidden" class="form-control" name="employee" id="employee_id" value="{{ Session::get('employee')->id }}">
