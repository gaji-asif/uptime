                ...
                <input type="text" placeholder="Search employee" class="form-control" style="width:unset;" value="" id="employee_search" name="search_employee" data-employee_id="{{Auth::guard('admin')->user()->id}}">
                  ...
                  @endif
                    <a class="nav-link dropdown-toggle" id="UserDropdown" href="#" data-toggle="dropdown" aria-expanded="false">
                      ...
                      <img class="img-xs rounded-circle" src="<?php echo \Storage::disk('s3')->url('images/user/'.Session::get('employee')->image);?>" alt="profile image" onerror="this.src='<?php echo \Storage::disk('s3')->url('images/avatar.png'); ?>'">
                      @else
 ...
 <!-- Nav bar for Employee Start-->
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
          <ul class="nav">
            <li class="nav-item nav-profile">
              ...
              <div class="nav-link">
                <div class="profile-image">
                  ...
                  @if(  Auth::guard('admin')->user()->image != '')
                  <img height="88px" src="<?php echo \Storage::disk('s3')->url('images/user/'. Auth::guard('admin')->user()->image);?>" alt="profile image" onerror="this.src='<?php echo \Storage::disk('s3')->url('images/avatar.png'); ?>'">
                  @else
            ...
            <li class="nav-item"> <a class="nav-link dashboard" href="{{ route('rep.dashboard') }}"> <img class="menu-icon" src="{{ asset('images/theme_menu_icons/02.png') }}" alt="menu icon"> <span class="menu-title">Dashboard</span></a> </li>
            
            <li class="nav-item {{getActiveClass('employee')}}"><a class="nav-link white-color" href="{{ route('rep.employee.list') }}"><img class="menu-icon" src="{{ asset('images/theme_menu_icons/14.png') }}" alt="menu icon"><span class="menu-title">Employee</span></a></li> 

            <li class="nav-item {{getActiveClass('industry')}}"><a class="nav-link white-color" href="{{ route('rep.industry.list') }}"><img class="menu-icon" src="{{ asset('images/theme_menu_icons/14.png') }}" alt="menu icon"><span class="menu-title">Store</span></a></li>            

            <li class="nav-item {{getActiveClass('categories')}}"><a class="nav-link white-color" href="{{ route('rep.categories.list') }}"><img class="menu-icon" src="{{ asset('images/theme_menu_icons/09.png') }}" alt="menu icon">Categories</a></li>


            <li class="nav-item {{getActiveClass('builds')}}"><a class="nav-link white-color" href="{{ route('rep.builds.list') }}"><img class="menu-icon" src="{{ asset('images/theme_menu_icons/20.png') }}" alt="menu icon">Submissions</a></li>
    ...
    $(document).ready(function(){
      $( "#employee_search" ).autocomplete({
        ...
        select: function (event, ui) {
          ...
          window.location.href = "{{ url('/rep/test/') }}/" + ui.item.id +"/" + ui.item.startDate + "/" + ui.item.endDate;
