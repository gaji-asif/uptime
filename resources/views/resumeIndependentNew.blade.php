    ...
    <!-- report text and line  -->
        <div class="row report-layer">
          ...
          <div class="row margin-top-25">
            <div class="col-lg-5 userDeatails common_padding background_color_white">
              <div class="row">
              <div class="col-4">
                @if($user_data['image'] != '')
              ...
              <div class="col-8">
                ...
                <font class="user_name">{{$user_data['name']}}</font> <br><br>
                <span style="float: left;">
                  <button class="btn btn-success" style="border: none; margin-bottom:10px;" onclick="bookNow('<?php echo $user_data['phone_number'];?>')">
            ...
            <div class="col-lg-4">
              <div class="personal_info internal_padding_top">
            ...
            <div class="col-lg-3 common_padding background_color_white">
              <font class="user_name margin_bottom_5">My Objective</font><br>
              <p class="description">Start My Own Barbar Shop in 2015 to build a better business for future.</p>
            </div>
          </div>
        </div>
          <!-- // start second Row -->
          ...
          <div class="row">
            <div class="col-lg-5 common_padding background_color_white">
              @if (isset($buildSuccessRate))
               @php
                ...
                @endphp
              <div class="verified_number verified_wrapper">
                  <div class="meta">
            ...
            <div class="col-lg-4 hardworker_wrapper common_padding">
              <div class="row">
                <div class="badges col-lg-3">
                  <img src="{{asset('images/hardworker.png')}}">
                </div>
              <div class="hardWorker col-lg-9">
            ...
            <div class="col-lg-3 reviews_wrapper">
              <div class="row">
                <div class="col-lg-6">
                  <div class="row background_color_white common_padding">
                    asdasdasdasd asasdasd
                  </div>
                </div>
               <div class="col-lg-6">
                  <div class="row background_color_white common_padding">
