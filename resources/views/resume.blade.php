        ...
        <div class="row report-layer">
          ...
          <div class="row">
            <div class="col-md-4">
                <div class="row">
                  <div class="h-col-2">
                     <button type="submit" class="btn form-control print-button" style="background-color:#89dceb;">
                  ...
                  <div class="h-col-x6">
                     <input type="text" class="form-control" name="daterange" readonly="readonly" value="{{$user_data['startmonth']}} - {{$user_data['endmonth']}}" />
                      ...
                      <input type="hidden" value="{{$user_data['last_month']}}" class="form-control" id="last_month">
                  ...
                  <div class="h-col-2">
                    ...
                    <!-- <form method="get" action="{{route('master.makepdf')}}"> -->
                      @csrf
                      @if (auth('admin')->check())
            ...
            <div class="col-md-4">
              <div class="row">
                  <div class="h-col-12">
                          ...
                          <form method="get" action="{{route('employeeportfolio.employeeportfolio.dateindex',['id'=>$user_data['id'],'startdate'=>$user_data['startmonth'],'enddate'=>$user_data['endmonth']])}}">
                            <div class="row">
    ...
    <div class="row margin_top_25">
        ...
        <div class="col-sm-3 col-xs-12">
            <div class="profile-pic-layer">
                ...
                @else
                    <img id="profileImage" class="img-circle" src="{{ asset('images/avatar.png') }}" alt="Profile image">
                @endif
            </div>
            ...
            <div class="personal_info">
                <div class="detail text-padding"><span><i class="fas fa-envelope"></i></span><a href="mailto:<?php echo $user_data['email'];?>">{{$user_data['email']}}</a></div>
                ...
                @endif
                <div class="detail text-padding"><span><i class="fas fa-building"></i></span>{{$user_data['company']}}</div>
                <div class="detail text-padding"><span><i class="fas fa-layer-group"></i></span>{{$user_data['level']}}</div>
                <div class="detail text-padding"><span><i class="fas fa-hourglass-start"></i></span>{{$user_data['times']}}</div>
            </div>
                          ...
                          <div class="col-md-6 sales-second-layer">
                              <div class="row">
                                   <div class="col-md-12  sales-image-layer">
                                       @if($categories->count())
                                            <div class="title cat_name_title">{{ $categories->first()->name }}</div>
                                                <div class="row">
                                                     <div class="owl-carousel circleslider" id= "sales-image-slider">
                                                          @foreach($categories->first()->subcategories as $index => $subcategory)
                                                               <div class="slider-item">
                                                                  <div class="circle {{ Uptime::getCategoryColor($index) }}" id="{{ $subcategory->id }}">
                                                                      ...
                                                                      <div class="sales-number sales-padding">{{ $subcategory->builds_count }}</div>
                                     ...
                                     <!--  <div class="subcat-description">Tablets sold within October-November 2018</div> -->
                                       <div class="row">
                                           ...
                                           @if(!empty($categories->first()))
                                            <div class="owl-carousel owl-theme buildslider hide" id="{{ $categories->first()->id }}buildslider">
                                            </div>
                                           @endif
                             ...
                             <div class="row challegne-button-layer">
                               <div class="col-md-4 my-col-4">
                                     <div class="challenge-button"  id = "1">
                                         <img src="<?php echo \Storage::disk('s3')->url('images/timedChallenge.png');?>" alt="Region Challenge image" class="bg-img">
                                         <div class="sub_title">
                               ...
                               <div class="col-md-4 my-col-4">
                                  ...
                                  <div class="challenge-button"  id = "2" style="visibility: hidden">
                                         <img src="<?php echo \Storage::disk('s3')->url('images/gray_challenge.png');?>" alt="Region Challenge image" class="bg-img">
                                         <div class="sub_title">
                       ...
                       @if($categories->count())
                         @foreach($categories as $key => $category)
                          ...
                          <div class="row training-slider-layer">
                           <div class="col-md-12">
                              <div class="title cat_name_title">{{ $category->name }}</div>
                              <div class="row">
                                <div id="training-slider" class="owl-carousel circleslider">
                                   @foreach($category->subcategories as $index => $subcategory)
                                       <div class="slider-item">
                                           <div class="circle {{ Uptime::getCategoryColor($index) }}" id="{{ $subcategory->id }}">
                                              <img style ="width:30%" src="{{ \Storage::disk('s3')->url('images/employeeview/'. Uptime::getCategoryImage($key, $index)) }}" alt="Coaching image" class="sales-icon">
                                              <div class="sales-number sales-padding">{{ $subcategory->builds_count }}</div>
                                              <div class="circle-text ">{{ $subcategory->name }}</div>
                                           </div>
                                       </div>
                            ...
                            <div class="row">
                                 ...
                                 <div class="col-md-12">
                                       <div class="owl-carousel buildslider" id="{{ "{$category->id}buildslider" }}">
...
{{--                               <h4>{{count($testinomials_data['employee'])}} Promoters</h4>--}}
                            <h4 class="text-danger pr-4"><img src="{{ asset('images/verified_clients.png') }}" alt="" width="30"> Verified Clients ({{ count($testinomials_data['employee'])}})</h4>
                              ...
                              <div id="reference-list" class="reference-modal">
                                ...
                                <div class="list-container">
                                  <h1 class="reference-list-item" style="display: block">Promoters</h1>
...
{{--                                      @if($testinomial['image'] != '')--}}
                                          <img style="height: 50px;width: 50px; object-fit:cover;" class="duels-image" src="{{ $testinomial['image'] }}" alt="profile image" onerror="this.src='<?php echo url('images/avatar.png'); ?>'">
{{--                                      @else--}}
{{--                                          <img style="height: 50px;width: 50px; object-fit:cover;" class="duels-image" src="{{ asset('images/avatar.png') }}" alt="Profile image">--}}
{{--                                      @endif--}}
                                    </div>
                                      <div class="reference-list-item-middle">
                                        <div>{{$testinomial['full_name']}}</div>
                                        <a href='mailto:{{$testinomial['email']}}'>{{$testinomial['email']}}</a>
                                        (xxx) xxx-x{{substr($user_data['phone_number'], -3)}}
                                      </div>
                            ...
                            <div class="row testinomial-layer">
                              ...
                              <div class="col-md-12">
                                <div id="testinomila-carousel" class="owl-carousel">
                                  @foreach($testinomials_data['employee'] as $testinomial)
                                    @if ($loop->index > 4)
                                      @break
                                    @endif
...
{{--                                      @if($testinomial['image'] != '')--}}
                                          <img style="height: 50px;width: 50px;margin: auto;" class="duels-image" src="{{ $testinomial['image'] }}" alt="profile image" onerror="this.src='<?php echo url('images/avatar.png'); ?>'">
{{--                                      @else--}}
{{--                                          <img style="height: 50px;width: 50px;margin: auto;" class="duels-image" src="{{ asset('images/avatar.png') }}" alt="Profile image">--}}
{{--                                      @endif--}}
                                        </a>
                                      <div>{{$testinomial['full_name']}}</div>
                                      <div class="row">
      ...
      <div class="my-modal-content">
        <div class="col-md-12">
          <div class="modal-header">
            <h4 style="margin:auto">Book Now</h4>
          ...
          <div class="modal-body" style="text-align: center; height: calc(100% - 55px);">
            ...
            <div id="smsTextInput">
              <textarea name="" id="bookSmsText" rows="10" placeholder="Please input Text here" class="form-control" style="border-color:#333">
              </textarea>
    ...
    <script>
      ...
      $(function() {
          $('input[name="daterange"]').daterangepicker({
            ...
            location.href= "{{ url('employeeportfolio') }}/"+id+"/"+$('#date_timepicker_start').val()+"/"+$('#date_timepicker_end').val();
    ...
    $(document).ready(function() {
     ...
     $('.search_category').change(function(){
         ...
         location.href = "{{ url('employeeportfolio') }}/"+id+"/"+$('#date_timepicker_start').val()+"/"+$('#date_timepicker_end').val()+'/'+category;
     });
     ...
     $(".buildslider").on("click", ".mItem", function(e){
        ...
        if(true){
             ...
             $.ajax({
                      ...
                      url: "{{ url('employeeportfolio/getbuildinfofromid') }}/"+id+"/"+sub_id+"/"+$('#date_timepicker_start').val()+"/"+$('#date_timepicker_end').val(),
                      type:'POST',
                      dataType:'json',
            ...
            $.ajax({
                  ...
                  url: "{{ url('employeeportfolio/getbuildinfofromid') }}/"+id+"/"+sub_id+"/"+$('#date_timepicker_start').val()+"/"+$('#date_timepicker_end').val()+'/'+search_text,
                  type:'POST',
                  dataType:'json',
                  success: function(result){
                      if(result.status){
    ...
    $('.circle').click(function(e){
          ...
          var search_text = $('#search_text').val();
              ...
              if($(this).hasClass("clicked")){
                  ...
                  $(this).removeClass("circle-border");
                      ...
                      url: "{{ url('employeeportfolio/getbuildsfromsubcatid')}}/"+emp_id +"/"+id+"/"+$('#date_timepicker_start').val()+"/"+$('#date_timepicker_end').val(),
                      type:'POST',
                      dataType:'json',
                      success: function(result){
                          if(result.status){
          ...
          if($(this).hasClass("clicked")){
              ...
              $(this).removeClass("circle-border");
                  ...
                  url: "{{ url('employeeportfolio/getbuildsfromsubcatid')}}/"+emp_id +"/"+id+"/"+$('#date_timepicker_start').val()+"/"+$('#date_timepicker_end').val() + '?search=' + search_text, //+"/"+search_text,
                  type:'POST',
                  dataType:'json',
                  success: function(result){
                      if(result.status){
