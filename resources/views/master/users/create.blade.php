    ...
    @endif
      ...
      <div class="card col-md-8">
        <div class="card-body">
            ...
            <form action="{{ url('master/users/store') }}" autocomplete="nope" method="POST" class="forms-sample" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                    <strong><label for="accesscode">Access Code</label></strong>
                    <input type="text" name="accesscode" id="accesscode" class="form-control" placeholder="accesscode">
                </div>
