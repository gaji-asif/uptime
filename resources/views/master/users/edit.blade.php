...
<div class="content-wrapper">
    ...
    <div class="card col-md-8">
        <div class="card-body">       
            ...
            <form action="{{ url('master/users/update',$users->id) }}" method="POST" class="forms-sample"  enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group  ">
                    <strong><label for="full_name">Company Name *</label> </strong>
                    <input type="text" name="full_name" id="full_name" class="form-control" placeholder="Company Name" value="{{$users->name}}">
                </div>
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                    <strong><label for="access_code">Access Code</label></strong>
                    <input type="text" name="access_code" id="access_code" class="form-control" value = "{{$users->access_code}}" placeholder="accesscode">
                </div>
