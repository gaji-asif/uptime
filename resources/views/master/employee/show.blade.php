                ...
                <div class="tab-pane fade" id="eInfo" role="tabpanel" aria-labelledby="home-tab">
                  ...
                  <div class="row">
                    <div class="extra-link col-md-3">
                      <a class="btn btn-light btn-fw" href="{{ url('master/users',$employee->company_id) }}">View company detail &nbsp;<i class="fa fa-arrow-circle-right"></i></a>
                    </div>
                    @if($employee->build != 0)
                    <div class="extra-link col-md-3">
                      <a class="btn btn-light btn-fw" href="<?PHP echo url('master/builds/employee/'.$employee->id) ;?>">View Build list &nbsp;<i class="fa fa-arrow-circle-right"></i></a>
                    </div>
                    @endif
                    @if($employee->validation != 0)
                    <div class="extra-link col-md-3">
                      <a class="btn btn-light btn-fw" href="<?PHP echo url('master/validations/employee/'.$employee->id) ;?>">View Validation list &nbsp;<i class="fa fa-arrow-circle-right"></i></a>
                    </div>
                    @endif
                    <div class="extra-link col-md-3">
                      <a class="btn btn-light btn-fw" href="<?PHP echo url('master/tenure/employee/'.$employee->id) ;?>">View Tenure &nbsp;<i class="fa fa-arrow-circle-right"></i></a>
                    </div>
                  </div>
                </div>
                ...
                <div class="tab-pane fade active show" id="eProfile" role="tabpanel" aria-labelledby="profile-tab">
                  ...
                  <div class="col-md-12">
                      ...
                      <div class="col-md-2 text-center fltleft">
                          ...
                          <div class="details">
                              <a href="{{url('master/employee/status/'.$employee->id.'/1')}}"  target="_blank"><button class="btn btn-success">More Details</button></a>
                          </div>
                      </div>
                      <div class="col-md-2 text-center fltleft">
                          <div class="round">
                          ...
                          <div class="details">
                              <a href="{{url('master/employee/status/'.$employee->id.'/0')}}" target="_blank"><button class="btn btn-danger">More Details</button></a>
                          </div>
                      </div>
                  </div>
                  ...
                  <div class="col-md-12 fltleft">
                      ...
                      <div class="col-md-2 text-center fltleft">
                          ...
                          <div class="details">
                              <!-- <a href="{{url('master/employee/downloadresume/'.$employee->id)}}" target="_blank"><button class="btn btn-warning">Profile PDF</button></a> -->
                              @if($employee->userType == "1" && $employee->company_id != 119)
                              <a href="{{ url('master/test/'.$employee->id.'/'.\Carbon\Carbon::parse($employee->created_at)->format('m-d-Y').'/'.\Carbon\Carbon::today()->format('m-d-Y')) }}"><button class="btn btn-warning">Profile PDF</button></a>
                              @else
                              <a href="{{ url('master/testdateIndependent/'.$employee->id.'/'.\Carbon\Carbon::parse($employee->created_at)->format('m-d-Y').'/'.\Carbon\Carbon::today()->format('m-d-Y')) }}"><button class="btn btn-warning">Profile PDF</button></a>
                              @endif
                          </div>
                      </div>
                      <div class="col-md-2 text-center fltleft">
          ...
          if(!empty($maincategory_data)){
            ...
            foreach($maincategory_data as $key => $cat){
              ...
              foreach ($subcategory_data[$i] as $key1 => $value) {
                  echo '<tr class="datarow"><td>'.$key1.'</td><td>'.$value.'</td></tr>';
              }
              $i++;
