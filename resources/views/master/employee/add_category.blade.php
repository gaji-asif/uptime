...
<div class="content-wrapper">
    ...
    <div class="card col-md-8">
        <div class="card-body">
            ...
            <form action="{{route('admin.employee.categories.store')}}" method="POST" class="forms-sample">
                @csrf
                ...
                <div class = "from-group">
                     <strong><label for="sub_category_name">Region Select *</label></strong>
                     <select class="form-control" name="region_select" id="region_select" required><option id ="">select region</option>
