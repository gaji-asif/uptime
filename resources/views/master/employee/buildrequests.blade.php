...
function requestLinsting(){ 
    ...
    var ajax_url2 = '<?php echo url('admin/employee/build requests/buildsrequestdatatable');?>';
    
   
    var url1 = '<?php echo url('admin/employee/buildshow');?>';
    var aurl = '<?php echo url('admin/employee/approve-request');?>';
    var viewurl = '<?php echo url('admin/employee/view-request');?>';
