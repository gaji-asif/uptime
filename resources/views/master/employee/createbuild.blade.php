...
<div class="content-wrapper">
    ...
    <div class="card col-md-8">
        <div class="card-body">
            ...
            <form action="{{route('admin.employee.builds.storebuild')}}" method="POST" class="forms-sample"  enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <select class="form-control buil-category-add_emp" name="category" id="category_id" required  data-id="0">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" name="challenge" id="challenge_id" disabled>
                        <option value="0">selecte employee for challenge list</option>
                    </select>
                </div>                
