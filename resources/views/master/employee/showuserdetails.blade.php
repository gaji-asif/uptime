               ...
               <div class="tab-pane fade" id="eInfo" role="tabpanel" aria-labelledby="home-tab">
                  ...
                  <div class="row">
                    <div class="extra-link col-md-3">
                      <a class="btn btn-light btn-fw" href="{{ url('users/show',$employee->company_id) }}">View company detail &nbsp;<i class="fa fa-arrow-circle-right"></i></a>
                    </div>
                    @if($employee->build != 0)
                    <div class="extra-link col-md-3">
                 ...
                 <h4>  {{ $employee->full_name }}</h4>
                  ...
                  <div class="col-md-12 fltleft">
                      ...
                      <div class="col-md-2 text-center fltleft">
                          ...
                          <div class="details">
                              <a href="{{url('employee/downloadresume/'.$employee->id)}}" target="_blank"><button class="btn btn-warning">Daily Achievement</button></a>
                          </div>
                      </div>
                      <div class="col-md-2 text-center fltleft">
                          <div class="squre">
      ...
      <div class="modal-body">
        <?php
          if(!empty($challangeiesByEid)){
            echo '<table class="table"><thead><tr><th>Sub Categories</th><th>Win Count</th></tr></thead>';
            foreach($challangeiesByEid as $key => $cat){
...
<div id="leaderboard" class="modal fade" role="dialog">
  <div class="modal-dialog modal-md">
    ...
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title">Challenges and points</h4>
      </div>
      <div class="modal-body">
        <?php
