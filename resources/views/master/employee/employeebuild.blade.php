            ...
            <div class="row">
                ...
                <div class="col-lg-12 margin-tb">
                    ...
                    <div class="pull-right">
                        <a class="btn btn-theme margin-bottum-10" href="{{ route('admin.employee.builds.createbuild') }}"> Create New Build</a>
...
function oderLinsting(){
    ...
    var ajax_url = '<?php echo url('admin/employee/build/buildsdatatable');?>';
    
   
    var url = '<?php echo url('admin/employee/buildshow');?>';
    var durl = '<?php echo url('admin/employee/builds/delete');?>';
    var eurl = '<?php echo url('admin/employee/edit-build');?>';
...
$('.delete_build').on('click', function(e){
    ...
    var ajaxurl = '<?php echo url('admin/employee/builds/builddelete');?>';
