            ...
            <div class="row">
                <div class="col-lg-12 margin-tb">
                    ...
                    <div class="pull-right">
                        <a class="btn btn-theme margin-bottum-10" href="{{ route('admin.employee.categories.create')  }}"> Create New Sub Category</a>
                    </div>
                </div>
            </div>
            <div class="row">
...
function oderLinsting(){
    ...
    var url = '<?php echo url('admin/employee/categories');?>';
    var durl = '<?php echo url('admin/employee/categories/delete');?>';
    var users_show = '<?php echo url('users');?>';
    $('#order-listing').DataTable({
        processing: true,
        serverSide: true,
        ajax: '<?php echo url('admin/employee/categories/categorydatatable');?>',
        "oLanguage": {
            "oPaginate": {
