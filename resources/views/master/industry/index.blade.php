            ...
            <div class="row">
                <div class="col-lg-12 margin-tb">
                    ...
                    <div class="pull-right">
                        <a class="btn btn-theme margin-bottum-10" href="{{ url('master/industry/create') }}"> Create New Store</a>
                    </div>
                </div>
            </div>
            <div class="row">
...
function oderLinsting(){
    ...
    var url = '<?php echo url('master/industry');?>';
    var durl = '<?php echo url('master/industry/delete');?>';
    var users_show = '<?php echo url('master/users');?>';
    $('#order-listing').DataTable({
        processing: true,
        serverSide: true,
        ajax: '<?php echo url('master/industry/industrydatatable');?>',
        "oLanguage": {
            "oPaginate": {
