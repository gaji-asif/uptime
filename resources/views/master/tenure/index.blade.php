...
function oderLinsting(){
    ...
    var ajax_url = '<?php echo url('master/tenure/tenuredatatable');?>';
    if(call_from == '1'){
        var ajax_url = '<?php echo url('master/tenure/employee-data/'.$tenure->employee_id);?>';
    }
     
    var url = '<?php echo url('master/tenure');?>';
    var durl = '<?php echo url('master/tenure/delete');?>';
    var employee_show = '<?php echo url('master/employee');?>';
...
$('.delete_tenure').on('click', function(e){
    ...
    var ajaxurl = '<?php echo url('master/tenure/tenuredelete');?>';
    if(array.length == 0){
