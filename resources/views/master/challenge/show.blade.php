              ...
              <div class="row">
                  ...
                  <div class="tab-content tab-body" id="profile-log-switch">
                    <div class="tab-pane fade show active pr-3" id="user-profile-info" role="tabpanel" aria-labelledby="user-profile-info-tab">
                      <table class="table table-borderless w-100 mt-4">
                        ...
                        <tr>
                          <td>Submission Name :<strong> {{ (isset($challenge->build_name) ? $challenge->build_name : '--') }}</strong></td>
                           <td>SubCategory Name :<strong> {{ (isset($challenge->subcategories) ? $challenge->subcategories : '--') }}</strong></td>
                        </tr>
                        <tr>
                          <td>created At :<strong> {{ $challenge->created_date }}</strong></td>
                        </tr>
                      </table>
                      @if($challenge->status != '-1')
                      <div class="extra-link">
                        <a class="btn btn-light btn-fw" href="{{ url('master/main/builds')}}">View Submission Detail &nbsp;<i class="fa fa-arrow-circle-right"></i></a>
                      </div>
                      @endif
                    </div>
                  </div>
                ...
                <div class="col-md-3">
                  ...
                  <div class="new-accounts user-detail-image">
                    @if($challenge->image != '')
                    <img src="<?php echo \Storage::disk('s3')->url('images/challenge/'.$challenge->image);?>" alt="Submission image" width="200px" onerror="this.src='<?php echo url('images/no_image.png'); ?>'">
                    @else
