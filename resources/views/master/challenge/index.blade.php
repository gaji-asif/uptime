            ...
            <div class="row">
                <div class="col-lg-12 margin-tb">
                    ...
                    <div class="pull-right">
                        <a class="btn btn-theme margin-bottum-10" href="{{ url('master/challenge/create') }}"> Create New Challenge</a>
...
function oderLinsting(){
    ...
    var url = '<?php echo url('master/challenge');?>';
    var durl = '<?php echo url('master/challenge/delete');?>';
    var table = $('#order-listing').DataTable({
        processing: true,
        serverSide: true,
        ajax: '<?php echo url('master/challenge/challengedatatable');?>',
        "oLanguage": {
            "oPaginate": {
...
$('.delete_challenge').on('click', function(e){
    ...
    var ajaxurl = '<?php echo url('master/challenge/challangedelete');?>';
    if(array.length == 0){
