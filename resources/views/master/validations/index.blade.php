            ...
            <div class="row">
                <div class="col-lg-12 margin-tb">
                    ...
                    <div class="pull-right">
                        <a class="btn btn-theme margin-bottum-10" href="{{ url('master/validations/create') }}"> Create New Validation</a>
...
function oderLinsting(){
    ...
    var ajax_url = '<?php echo url('master/validations/validationsdatatable');?>';
    if(call_from == '1'){
        var ajax_url = '<?php echo url('master/validations/employee-data/'.$validations->employee_id);?>';
    }


    var url = '<?php echo url('master/validations');?>';
    var durl = '<?php echo url('master/validations/delete');?>';
...
$('.delete_validation').on('click', function(e){
    ...
    var ajaxurl = '<?php echo url('master/validations/validationdelete');?>';
    if(array.length == 0){
