            ...
            <div class="row">
                <div class="col-lg-12 margin-tb">
                    ...
                    <div class="pull-right">
                        <a class="btn btn-theme margin-bottum-10" href="{{ url('master/preset-challenge/create') }}"> Create Preset Challenge</a>
...
function oderLinsting(){
    ...
    var url = '<?php echo url('master/preset-challenge');?>';
    var durl = '<?php echo url('master/preset-challenge/delete');?>';
    var table = $('#order-listing').DataTable({
        processing: true,
        serverSide: true,
        ajax: '<?php echo url('master/preset-challenge/challengedatatable');?>',
        "oLanguage": {
            "oPaginate": {
