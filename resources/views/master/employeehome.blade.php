      ...
      <div class="card card-statistics">
        <div class="card-body">
          <div class="d-flex align-items-center justify-content-center">
            ...
            <div class="wrapper">
              <a href="{{ route('admin.categories.list') }}"><p class="card-text mb-0">Total Categories</p></a>
      ...
      <div class="card card-statistics">
        <div class="card-body">
          <div class="d-flex align-items-center justify-content-center">
            ...
            <div class="wrapper">
              <a href="{{ route('admin.employee.list') }}"><p class="card-text mb-0 theme-color">Total Employees</p></a>
              <div class="fluid-container">
      ...
      <div class="card card-statistics">
        <div class="card-body">
          <div class="d-flex align-items-center justify-content-center">
            ...
            <div class="wrapper">
              <a href="{{ route('admin.buildrequests.list') }}"><p class="card-text mb-0 theme-color">Total Builds</p></a>
              <div class="fluid-container">
      ...
      <div class="card card-statistics">
        <div class="card-body">
          <div class="d-flex align-items-center justify-content-center">
            ...
            <div class="wrapper">
              <a href="{{ route('admin.challengerequests.list') }}"><p class="card-text mb-0 theme-color">Total Challenges</p></a>
              <div class="fluid-container">
          ...
          <div class="new-accounts">
            <ul class="chats">
              ...
              <li class="chat-persons">
                <a href="{{url('admin/employee/buildshow/'.$wbuild->id)}}">
                  <span class="pro-pic">
        ...
        <div class="card-body">
          ...
          <div class="new-accounts">
            <ul class="chats">
              ...
              <li class="chat-persons">
                <a href="{{url('admin/employee/buildshow/'.$lbuild->id)}}">
                  <span class="pro-pic">
        ...
        <div class="card-body">
          ...
          <div class="new-accounts">
            <ul class="chats">
              ...
              <li class="chat-persons">
                <a href="{{url('admin/employee/buildshow/'.$cbuild->id)}}">
                  <span class="pro-pic">
        ...
        <div class="card-body">
          ...
          <div class="new-accounts">
            <ul class="chats">
              ...
              <li class="chat-persons">
                <a href="{{url('admin/employee/level-challenge/'.$challenge['id'])}}">
                  <span class="pro-pic">
